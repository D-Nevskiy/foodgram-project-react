...
from .views import TagViewSet, CustomUserViewSet, RecipeViewSet, \
    IngredientViewSet, UserSubscriptionViewSet,FavoriteRecipeViewSet, ShoppingCartViewSet
...
urlpatterns = [
    ...
    path('recipes/<int:recipe_id>/favorite/', FavoriteRecipeViewSet.as_view({'post': 'favorite', 'delete':'favorite'})),
    path('recipes/<int:recipe_id>/shopping_cart/', ShoppingCartViewSet.as_view({'post': 'shopping_cart', 'delete':'shopping_cart'})),
